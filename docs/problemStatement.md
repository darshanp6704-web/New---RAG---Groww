...
> [!IMPORTANT]
> **Active Corpus Limit (Current Scope)**
> Currently, the system is limited to retrieving from the following 5 URLs:
...
- Answer facts-only queries, such as:
  ...
  - Benchmark index
  - Fund management data (e.g., fund manager name, tenure, and education)
